...
mysql -u root -e "CREATE DATABASE IF NOT EXISTS vanilla" -ppassword
...
mkdir db
cd db
git clone https://github.com/abhinay100/vanilla_db.git .
mysql -u root vanilla < /tmp/db/vanilla.sql -ppassword
