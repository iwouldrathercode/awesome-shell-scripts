...
mysql -u root -e "CREATE DATABASE IF NOT EXISTS drupal" -ppassword
...
mkdir db
cd db
git clone https://github.com/abhinay100/drupal_db.git .
mysql -u root drupal < /tmp/db/drupal.sql -ppassword
