...
mysql -u root -e "CREATE DATABASE IF NOT EXISTS fengoffice" -ppassword
...
mkdir db
cd db
git clone https://github.com/abhinay100/feng_db.git .



mysql -u root fengoffice < /tmp/db/fengoffice.sql -ppassword
