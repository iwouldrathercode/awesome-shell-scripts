...
mysql -u root -e "CREATE DATABASE IF NOT EXISTS phpbb" -ppassword
...
git clone https://github.com/abhinay100/phpbb_db.git .
mysql -u root phpbb < /tmp/db/phpbb.sql -ppassword
