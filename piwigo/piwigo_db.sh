...
mysql -u root -e "CREATE DATABASE IF NOT EXISTS piwigo" -ppassword
...
mkdir db
cd db
git clone https://github.com/abhinay100/piwigo_database.git .



mysql -u root piwigo < /tmp/db/piwigo.sql -ppassword
