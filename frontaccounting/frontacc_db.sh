...
mysql -u root -e "CREATE DATABASE IF NOT EXISTS frontaccounting" -ppassword
...
mkdir db
cd db
git clone https://github.com/abhinay100/front_db.git .



mysql -u root frontaccounting < /tmp/db/frontaccounting.sql -ppassword
