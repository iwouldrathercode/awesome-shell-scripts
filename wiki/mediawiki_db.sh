...
mysql -u root -e "CREATE DATABASE IF NOT EXISTS mediawiki" -ppassword
...
git clone https://github.com/abhinay100/dbmedia.git .
mysql -u root mediawiki < /tmp/db/mediawiki.sql -ppassword
